...
export default function MyStory() {
  return (
    <>
      <section className="bg-secondary text-primary p-7 md:pb-15 md:pt-9 border-b-3 border-b-tertiary">
        <div className="max-w-7xl mx-auto">
          <h2 className="pt-3 pb-5 text-2xl md:text-3xl">My Story</h2>
      ...
      <section className="bg-primary text-secondary p-5 md:py-9 md:text-2xl border-b-4 border-b-tertiary">
        <div className="max-w-7xl mx-auto">
          <h2 className="pt-3 pb-5 text-2xl md:text-3xl text-tertiary">Section 2</h2>
