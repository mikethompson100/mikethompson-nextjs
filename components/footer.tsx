    ...
    <footer className="bg-secondary color-black px-4 py-4 md:text-3xl border-b-4 border-b-[var(--color-tertiary)] flex">
      <div className="max-w-7xl mx-auto flex-1 flex justify-between flex-col sm:flex-row h-23 sm:h-12 items-start sm:items-center">
        <div className="bord">
          ...
          <a href="https://www.mikethompson100.com/pdf/resume_pt_121525.pdf" title="resume" target="_blank" aria-label="PDF Link to the resume of michael thompson"><svg className="h-12 w-12 text-gray-600 inline me-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
