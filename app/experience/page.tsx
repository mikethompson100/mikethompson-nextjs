    ...
    <>
      <section className="bg-secondary color-primary p-5 md:py-9 border-b-4 border-b-[var(--color-tertiary)]">
        <div className="max-w-7xl mx-auto">
          <h2 className="pt-3 pb-5 text-2xl md:text-3xl">Experience</h2>
          <h3 className="text-xl md:text-2xl">This is sample copy for the experience page. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy. This is sample copy.</h3>
